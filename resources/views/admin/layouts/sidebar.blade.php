            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="{{ route('admin.user.index') }}">Employees</a></li>
                                @endif 
                        ...
                        <!-- Master -->
                        @if (hasAdminPermission('manage customer') || hasAdminPermission('manage package_type') || hasAdminPermission('manage destination') || hasAdminPermission('manage contract') || hasAdminPermission('manage vehicle_type'))
                        <li>
                            <a href="javascript:void(0);" class="has-arrow">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="{{ route('admin.packagetype.index') }}" data-key="t-package-type">Package Type</a></li>
                                @endif
                                ...
                                <li><a href="{{ route('admin.vehicletype.index') }}" data-key="t-vehicle-type">Vehicle Type</a></li>
                                @endif
                            </ul>
                        </li>
                        @endif
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                {{-- Uncomment if you want to enable Permissions menu
                        ...
                        <li>
                            <a href="{{ route('admin.settings.index') }}">
                                <i data-feather="database"></i>
                                <span data-key="t-company-settings">Company Settings</span>
                            </a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li><a href="{{ route('admin.profit_loss.index') }}" data-key="t-profit-loss">Profit & Loss</a></li>
                                <li><a href="{{ route('admin.gst.index') }}" data-key="t-gst">GST</a></li>
