                   ...
                   <tbody>
                     @if(!empty($bills))
                        ...
                        @endforeach
                         ...
                         <a href="{{ route('admin.freight-bill.view', $e->id) }}"
                          class="btn btn-sm btn-light view-btn" data-bs-toggle="tooltip"
                          title="View Freight Bill"><i class="fas fa-eye text-primary"></i></a>
                        @endif
                          @if (hasAdminPermission('edit freight_bill'))
                         <a href="{{ route('admin.freight-bill.edit', ['id' => $e->id]) }}" class="btn btn-sm btn-light" data-bs-toggle="tooltip"
                          title="Edit Freight Bill"><i class="fas fa-pen text-warning"></i></a>
                        @endif
                        
                           @if (hasAdminPermission('delete freight_bill'))
                         <a href="{{ route('admin.freight-bill.delete', $billNumber) }}" data-url=""
                          class="btn btn-sm btn-light delete-btn" data-bs-toggle="tooltip"
                          title="Delete Freight Bill"  onclick="return confirm('Are you sure you want to delete this freight bill?');">
                          <i class="fas fa-trash text-danger"></i>
                         </a>
                          @endif
                          
                          @if ($e->invoice)
                              <a href="{{ route('admin.freight-bill.invoice-view', $e->id) }}"
                          ...
                          @else
                              <a href="{{ route('admin.freight-bill.generate-invoice', $e->id) }}"
                                  class="btn btn-sm btn-light generate-invoice-btn"
                                  data-bs-toggle="tooltip"
            ...
            <form action="{{ route('admin.freight-bill.store') }}" method="post">
               ...
               <div class="row">
                 <div class="col-md-6 mb-3">
                   ...
                   <input type="text" class="form-control" id="inputCompany" placeholder="Enter Notes" name="notes"
                     required>
                 </div>
               </div>
               <div class="text-end">
            ...
            <form id="editForm" method="post" action="">
               ...
               <div class="row">
                 ...
                 <div class="col-md-6 mb-3">
                   ...
                   <input type="text" class="form-control" placeholder="Enter notes" id="editCompany" name="notes"
                     required>
                 </div>
               </div>
               <div class="text-end">
