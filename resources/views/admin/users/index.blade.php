...
.address-group input {
    ...
    height: 45px;
    flex: 0 0 200px; /* fixed width for scrollable row */
}
                     ...
                     <div class="col-12">
                        <div class="address-section">
                           <div class="address-header">
                              <h5>🏠 Department / Divisons</h5>
                              <button type="button" class="btn add-address-btn" onclick="addAddress()">➕ Add More</button>
                           </div>
                           <div id="addressContainer">
                              <div class="address-group-wrapper">
                                    <div class="address-group">
                                       ...
                                       <input type="text" name="address[0][city]" class="form-control" placeholder="Location" required>
                                       <input type="text" name="address[0][gstin]" class="form-control" placeholder="GSTIN" required>
                                       <input type="text" name="address[0][billing_address]" class="form-control" placeholder="Billing Address" required>
                                       <input type="text" name="address[0][consignment_address]" class="form-control" placeholder="Consignment Address 1" required>
                                       <input type="text" name="address[0][consignment_address2]" class="form-control" placeholder="Consignment Address 2" required>
                                       <input type="text" name="address[0][mobile_number]" class="form-control" placeholder="Mobile Number" required>
                                       <input type="text" name="address[0][email]" class="form-control" placeholder="Email" required>
                                       <input type="text" name="address[0][poc]" class="form-control" placeholder="Point Of Contact" required>
                                    </div>
                              </div>
                           </div>
                        </div>
      ...
      <div class="col-12">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <!-- ✅ Addresses Block -->
               <hr>
               <h6>🏠 <strong>Department / Divisons</strong></h6>
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="mb-3">
                        <label class="form-label">💳 UPI ID</label>
                        <input type="text" name="upi_id" class="form-control" value="{{ $user->upi_id ?? '' }}" placeholder="Enter UPI ID">
                     </div>
                  </div>
                  <!-- Addresses -->
                  <div class="col-md-6">
   ...
   document.addEventListener("DOMContentLoaded", function () {
     ...
     document.querySelectorAll(".edit-btn").forEach(function (btn) {
       btn.addEventListener("click", function () {
         ...
         const upiId = row.getAttribute("data-upi-id") || "";
...
function addAddress() {
  let container = document.querySelector("#addressContainer .address-group-wrapper");
  let div = document.createElement("div");
  div.classList.add("address-group");
  div.innerHTML = `
    <select class="form-control" name="address[${addressIndex}][state]">
      <option value="">Select State</option>
      <option value="Madhya Pradesh">Madhya Pradesh</option>
      <option value="Uttar Pradesh">Uttar Pradesh</option>
      <option value="Maharashtra">Maharashtra</option>
    ...
    <input type="text" name="address[${addressIndex}][city]" class="form-control" placeholder="Location" required>
    <input type="text" name="address[${addressIndex}][gstin]" class="form-control" placeholder="GSTIN" required>
    <input type="text" name="address[${addressIndex}][billing_address]" class="form-control" placeholder="Billing Address" required>
    <input type="text" name="address[${addressIndex}][consignment_address]" class="form-control" placeholder="Consignment Address 1" required>
    <input type="text" name="address[${addressIndex}][consignment_address2]" class="form-control" placeholder="Consignment Address 2" required>
    <input type="text" name="address[${addressIndex}][mobile_number]" class="form-control" placeholder="Mobile Number" required>
    <input type="text" name="address[${addressIndex}][email]" class="form-control" placeholder="Email" required>
    <input type="text" name="address[${addressIndex}][poc]" class="form-control" placeholder="Point Of Contact" required>
